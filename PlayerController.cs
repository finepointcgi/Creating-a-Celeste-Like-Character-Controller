...
public class PlayerController : KinematicBody2D
{
    ...
    public override void _Process(float delta)
    {
        ...
        {
            dashTimer -= delta;
            GetNode<AnimatedSprite>("Shadow1").Frames = GetNode<AnimatedSprite>("AnimatedSprite").Frames;
            GetNode<AnimatedSprite>("Shadow1").SetFrame(GetNode<AnimatedSprite>("AnimatedSprite").GetFrame() - 1);
            if (dashTimer <= 0)
            {
                isDashing = false;
